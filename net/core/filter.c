...
/* compat structs for 5.x BPF reuseport backport */
struct bpf_prog_ops {
};
...
#define BPF_MAP_TYPE_REUSEPORT_SOCKARRAY 0xdeadbeef
#endif

/* 5.x sk_lookup BPF infrastructure */
#ifndef BPF_SK_LOOKUP_F_REPLACE
#define BPF_SK_LOOKUP_F_REPLACE		(1U << 0)
#define BPF_SK_LOOKUP_F_NO_REUSEPORT	(1U << 1)
#endif
					   ...
					   u32 *target_size)
{
	...
	case offsetof(struct sk_reuseport_md, ip_protocol):
		/* sk_protocol is a bit-field in 4.14, cannot use bpf_target_off */
		*insn++ = BPF_MOV32_IMM(si->dst_reg, 0);
		*target_size = 1;
		break;
